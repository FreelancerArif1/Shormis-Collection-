                ...
                <div class="wrap-in">
                                ...
                                <dd class="last odd color-img">
                                    <ol class="configurable-swatch-list last-child">
                                        <li style="line-height: 19px;">
                                            <a class="swatch-link has-image" href="#">
                                                <span class="swatch-label" style="height:15px; width:15px;">
                                                    <img width="15" height="15" title="Red" alt="Red" src="/assets/images/shopby/color1.jpg">
                                                    <span>Red</span>
                                                </span>
                                                <span class="count">(12)</span>
                                            </a>
                                        ...
                                        <li style="line-height: 19px;">
                                            <a class="swatch-link has-image" href="#">
                                                <span class="swatch-label" style="height:15px; width:15px;">
                                                    <img width="15" height="15" title="Yellow" alt="Yellow" src="/assets/images/shopby/color2.jpg">
                                                    <span>Yellow</span>
                                                </span>
                                                <span class="count">(12)</span>
                                            </a>
                                        ...
                                        <li style="line-height: 19px;">
                                            <a class="swatch-link has-image" href="#">
                                                <span class="swatch-label" style="height:15px; width:15px;">
                                                    <img width="15" height="15" title="Blue" alt="Blue" src="/assets/images/shopby/color3.jpg">
                                                    <span>Blue</span>
                                                </span>
                                                <span class="count">(12)</span>
                                            </a>
                                        ...
                                        <li style="line-height: 19px;">
                                            <a class="swatch-link has-image" href="#">
                                                <span class="swatch-label" style="height:15px; width:15px;">
                                                    <img width="15" height="15" title="Green" alt="Green" src="/assets/images/shopby/color4.jpg">
                                                    <span>Green</span>
                                                </span>
                                                <span class="count">(12)</span>
                                            </a>
                    ...
                    <div class="block block_cat">
                        <a class="banner5" href="#">
                            <img src="/assets/images/banner_right.jpg" alt="">
                        </a>
                    </div>
            ...
            <!-- sns_left -->
                ...
                <div id="sns_main" class="col-md-9 col-main">
                    <div id="sns_mainmidle">
                        ...
                        <a href="#">
                            <img src="/assets/images/banner-grid.jpg" alt="">
                        </a>
                    </p>
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    href="detail.html">
                                                    <span class="img-main">
                                                    <img src="/assets/images/products/15.jpg" alt="">
                                                    </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    href="detail.html">
                                                    <span class="img-main">
                                                    <img src="/assets/images/products/18.jpg" alt="">
                                                    </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    href="detail.html">
                                                    <span class="img-main">
                                                    <img src="/assets/images/products/19.jpg" alt="">
                                                    </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
        ...
        async message(){
            await this.form.post('/message').then(response => {
                if(response.data.status == 1){
                    Swal.fire({
                        imageUrl: '/uploads//assets//assets//assets/images/backend-logo.jpg',
                        icon:'success',

                            ...
                            <div class="row row-img">
                                ...
                                <div class="product-img-box col-md-4 col-sm-5">
                                    <div class="detail-img">
                                        <img src="/assets/images/products/13.jpg" alt="">
                                    </div>
                                    <div class="small-img">
                                    ...
                                    <div class="item-inner product_list_style">
                                        <div class="item-info">
                                            <div class="item-title">
                                                <a title="Modular Modern" href="detail.html">Modular Modern</a>
                                            </div>
                ...
                <div id="sns_left" class="col-md-3">
                    ...
                    <div class="block block-banner banner5">
                        <a href="#" class="banner22">
                            <img src="/assets/images/blog-banner1.jpg" alt="">
                        </a>
                    </div>
                </div>
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    <a class="product-image have-additional" href="detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="/assets/images/products/8.jpg">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    <a class="product-image have-additional" href="detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="/assets/images/products/26.jpg">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
        ...
        async message(){
            await this.form.post('/message').then(response => {
                if(response.data.status == 1){
                    Swal.fire({
                        imageUrl: '/uploads//assets//assets/images/backend-logo.jpg',
                        icon:'success',

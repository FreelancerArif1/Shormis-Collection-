                ...
                <div class="header-setting">
                    <div class="module-setting">
                        <div class="mysetting language-switcher">
                            <div class="tongle">
                                <img alt="" src="/assets/images/flag/english.png">
                                <span>English</span>
                            </div>
                            <div class="content">
                                <div class="language-switcher">
                                    <ul id="select-language">
                                            ...
                                            <li>
                                                ...
                                                <img alt="" src="/assets/images/flag/brazil.png">
                                                <span>Brazil</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index3.html">
                                                <img alt="" src="/assets/images/flag/france.png">
                                                <span>France</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="index4.html">
                                                <img alt="" src="/assets/images/flag/russian.png">
                                                <span>Russian</span>
                                                </a>
                                            </li>
                                        </ul>
                                            ...
                                            <div class="class2 row">
                                                ...
                                                <div class="col-sm-6 style-pd3">
                                                    <a class="banner5 banner22" href="#">
                                                        <img alt="" src="/assets/images/menu/bmenug.jpg">
                                                    </a>
                                                    <br>
                                                </div>
                                            </div>
                            ...
                            <li class="level0 custom-itemdrop-staticblock">
                                ...
                                <div class="wrap_dropdown fullwidth">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a class="banner5 banner22" href="#">
                                                <img alt="" src="/assets/images/menu/menu3.jpg">
                                            </a>
                                            <br>
                                        ...
                                        <div class="col-sm-3">
                                            <a class="banner5 banner22" href="#">
                                                <img alt="" src="/assets/images/menu/menu4.jpg">
                                            </a>
                                            <br>
                                        ...
                                        <div class="col-sm-3">
                                            <a class="banner5 banner22" href="#">
                                                <img alt="" src="/assets/images/menu/menu5.jpg">
                                            </a>
                                            <br>
                                        ...
                                        <div class="col-sm-3">
                                            <a class="banner5 banner22" href="#">
                                                <img alt="" src="/assets/images/menu/menu6.jpg">
                                            </a>
                                            <br>
                                    ...
                                    <div class="block-content content">
                                        <div class="block-inner">
                                            <ol id="cart-sidebar" class="mini-products-list">
                                                ...
                                                <li class="item odd">
                                                    <a class="product-image" title="Modular Modern" href="detail.html">
                                                        <img alt="" src="/assets/images/products/22.jpg">
                                                    </a>
                                                    <div class="product-details">
                                                        <a class="btn-remove" onclick="return confirm('Are you sure you would like to remove this item from the shopping cart?');" title="Remove This Item" href="#">Remove This Item</a>
                                                        <a class="btn-edit" title="Edit item" href="#">Edit item</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="bottom-pd2 col-sm-6">
                    <div class="payment">
                        <img src="/assets/images/sns_paymal.png" alt="">
                    </div>
                </div>
            </div>
        </div>
